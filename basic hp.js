var artName_array = ["Guernica","View of the Asylum and Chapel of Saint-Rémy","A Wheatfeil with Cypresses","Starry Night","Olive Orchard","Self Potrait","Self Potrait","Self Potrait","Self Potrait","Fictional Character","The persistence of Memory","The Old Guitarist","Sunday Afternoon on the Island of La Grande Jatte","Girl with a Pearl Earring","The Great Wave off Kanagawa","Realism","The Lighthouse","The Snake Artist","Impression Sunrise","The Stanza della segnatura","Self Potrait"];
var artistName_array = ["PABLO PICASSO","VINCENT VAN GOGH","VINCENT VAN GOGH","VINCENT VAN GOGH","VINCENT VAN GOGH","VINCENT VAN GOGH","VINCENT VAN GOGH","VINCENT VAN GOGH","VINCENT VAN GOGH","ARTIST","SALVADOR DALI","PABLO PICASSO","Georges Seurat","Johannes Vermeer","Katsushika Hokusai","Gustave Courbet","Unknown Artist","Unknown Artist","Claude Monet","Raphael","Rembrandt van Rijn"];
